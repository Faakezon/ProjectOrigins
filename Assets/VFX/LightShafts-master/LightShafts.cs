...
public partial class LightShafts : MonoBehaviour
{
	public void Start()
	{
		...
		if (m_Cameras == null || m_Cameras.Length == 0)
            m_Cameras = new UnityEngine.Camera[] { UnityEngine.Camera.main };
	...
	void UpdateShadowmap()
	{
		...
		if (m_ShadowmapCamera == null)
		{
            ...
            m_ShadowmapCamera = go.GetComponent<UnityEngine.Camera>();
	...
	{
        m_CurrentCamera = UnityEngine.Camera.current;
